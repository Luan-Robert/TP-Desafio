...
class DesafioAdapter(private val desafios: MutableList<Desafio>, private val onExcluirClick: (Desafio, Int) -> Unit) :
    ...
    override fun onBindViewHolder(holder: DesafioViewHolder, position: Int) {
        ...
        holder.bind(desafio, onExcluirClick, position)
    }
    ...
    inner class DesafioViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(desafio: Desafio, onExcluirClick: (Desafio, Int) -> Unit, position: Int) {
            btnExcluir.setOnClickListener {
                onExcluirClick(desafio, position)
            }
